...
import { PostCommentRequstDto } from '@/apis/request/board'
...
export default function BoardDetail() {
  ...
  const BoardDetailBottom = () => {
    ...
    // event handler: 좋아요 상자 상자 보기 클릭 이벤트 처리
    const onShowFavoriteClickHandler = () => {
      setShowFavorite(!showFavorite);
    }
    // event handler: 댓글 상자 상자 보기 클릭 이벤트 처리
    ...
    const onCommentSubmitButtonClickHandler = () => {
      ...
      const requestBody: PostCommentRequstDto = { content: comment };
        ...
        <div className='board-detail-bottom-button-box'>
          <div className='board-detail-bottom-button-group'>
            ...
            {favoriteList.length > 0 ?
              ...
              <div className='icon-empty-button'></div>
            }
          </div>
          <div className='board-detail-bottom-button-group'>
