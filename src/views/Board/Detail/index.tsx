    ...
    return (
      <div id='board-detail-top'>
        <div className='board-detail-top-header'>
          <div className='board-detail-title'>{'타이틀 제목 내용 확인하기'}</div>
          <div className='board-detail-top-sub-box'>
            <div className='board-detail-write-info-box'>
              ...
              <div className='board-detail-write-date'>{'2024. 08. 13'}</div>
            </div>
        ...
        <div className='board-detail-top-main'>
          <div className='board-detail-main-text'>{'메인 텍스트'}</div>
          <img className='board-detail-main-image' src='https://ojsfile.ohmynews.com/STD_IMG_FILE/2023/0508/IE003147553_STD.jpg' />
        </div>
      </div>
    )
  }
