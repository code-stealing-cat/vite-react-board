    ...
    return (
        <div id='pagination-wrapper'>
            <div className='pagination-change-link-box'>
                ...
                <div className='pagination-change-link-text' style={{ color: currentSection === 1 ? 'rgba(0, 0, 0, 0.2)' : 'rgba(0,0,0,0.7)' }} onClick={onPreviousClickHandler}>{'이전'}</div>
            </div>
            ...
            <div className='pagination-divider'>{'\|'}</div>
            <div className='pagination-change-link-box'>
                <div className='pagination-change-link-text' style={{ color: currentSection === totalSection ? 'rgba(0, 0, 0, 0.2)' : 'rgba(0,0,0,0.7)' }} onClick={onNextClickHandler}>{'다음'}</div>
                <div className='icon-box-small'>
